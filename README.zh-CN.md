...
> \[!NOTE]
>
> 完整测试报告可见 [📘 Lighthouse 性能测试](https://github.com/SFYYH/lobe-chat/wiki/Lighthouse.zh-CN)
...
> \[!TIP]
>
> 我们建议按照 [📘 LobeChat 自部署保持更新](https://github.com/SFYYH/lobe-chat/wiki/Upstream-Sync.zh-CN) 步骤重新部署。
...
> \[!NOTE]
>
> 有关 Docker 部署的详细说明，详见 [📘 使用 Docker 部署](https://github.com/SFYYH/lobe-chat/wiki/Docker-Deployment.zh-CN)
...
> \[!NOTE]
>
> 完整环境变量可见 [📘环境变量](https://github.com/SFYYH/lobe-chat/wiki/Environment-Variable.zh-CN)
...
插件提供了扩展 LobeChat [Function Calling][fc-link] 能力的方法。可以用于引入新的 Function Calling，甚至是新的消息结果渲染方式。如果你对插件开发感兴趣，请在 Wiki 中查阅我们的 [📘 插件开发指引](https://github.com/SFYYH/lobe-chat/wiki/Plugin-Development.zh-CN) 。
...
>
> - [x] [**插件一期**](https://github.com/SFYYH/lobe-chat/issues/73): 实现插件与主体分离，将插件拆分为独立仓库维护，并实现插件的动态加载
> - [x] [**插件二期**](https://github.com/SFYYH/lobe-chat/issues/97): 插件的安全性与使用的稳定性，更加精准地呈现异常状态，插件架构的可维护性与开发者友好
> - [ ] [**插件三期**](https://github.com/SFYYH/lobe-chat/issues/149)：更高阶与完善的自定义能力，支持插件鉴权与示例
...
[github-action-release-link]: https://github.com/SFYYH/lobe-chat/actions/workflows/release.yml
[github-action-release-shield]: https://img.shields.io/github/actions/workflow/status/lobehub/lobe-chat/release.yml?label=release&labelColor=black&logo=githubactions&logoColor=white&style=flat-square
[github-action-test-link]: https://github.com/SFYYH/lobe-chat/actions/workflows/test.yml
